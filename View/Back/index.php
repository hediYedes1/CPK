...
$listeC = $commandC->afficherCommand();
                    ...
                    <div class="col-lg-12">
                      ...
                      ?>
                                                <tr>
                                                    ...
                                                    <td><?php $i=$r['id'];echo "<a href='updateC.php?id=$i' class='btn btn-outline-success'>Update</a>"; ?></td>
                                                    <td><?php $i=$r['id'];echo "<a href='deleteC.php?id=$i' class='btn btn-outline-danger'>Delete</a>"; ?></td>
                                                </tr>
                                                <?php
                      }
                      ?>
...
<!-- Mirrored from demo.dashboardpack.com/sales-html/data_table.html by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 20 Nov 2023 13:40:12 GMT -->
