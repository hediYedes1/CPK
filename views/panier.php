...
<head>
  ...
  <meta name="keywords" content="bootstrap, bootstrap4" />
    ...
    <style>
          /* Styling for "Mettre A Jour Panier" button */
          .btn-mettre-a-jour {
            background-color: #28a745; /* Green color, you can change it */
            color: #fff;
          }

          /* Styling for "Continuer vos achats" button */
          .btn-continuer-achats {
            background-color: #007bff; /* Blue color, you can change it */
            color: #fff;
          }

          /* Styling for "Valider Commande" button */
          .btn-valider-commande {
            background-color: #dc3545; /* Red color, you can change it */
            color: #fff;
          }
              ...
              <div class="row">
                <div class="col-md-6">
                  <div class="row mb-5">
                    ...
                    <button class="btn btn-mettre-a-jour btn-sm btn-block">Mettre A Jour Panier</button>
                    </div>
                    <div class="col-md-6">
                    <button class="btn btn-continuer-achats btn-sm btn-block">Continuer vos achats</button>
                    </div>
                  </div>
                </div>
                <div class="col-md-6 pl-5">
                  <div class="row justify-content-end">
                    <div class="col-md-7">
                      ...
                      <div class="row">
                        <div class="col-md-12">
                        <button class="btn btn-valider-commande btn-sm btn-block" onclick="validateCommande(<?php echo htmlspecialchars(json_encode($selectedProducts), ENT_QUOTES, 'UTF-8'); ?>)">Valider Commande</button>
                        </div>
                      </div>
                      <script>
           setTimeout(function () {
