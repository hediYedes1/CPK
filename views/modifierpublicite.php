...
if (isset($_POST['modifier'])){
  ...
  $publicite= new Publicite($_POST['id_pub'],$_POST['type'],$_POST['image'],$_POST['nom'],$_POST['prix'],$_POST['prix_avec_remise'],$_POST['description'],$_POST['quantite'],$_POST['id_article']);
  var_dump($publicite);
