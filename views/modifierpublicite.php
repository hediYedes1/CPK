...
<body>
    ...
    <ul class="sidebar-nav" id="sidebar-nav">
      ...
      <li class="nav-item">
        ...
        <ul id="produits-nav" class="nav-content collapse " data-bs-parent="#sidebar-nav">
          ...
          <li>
            <a href="../views/consultercatalogue.php">
              <i class="bi bi-circle"></i><span>consulter produits</span>
            </a>
          </li>
          <li>
            <a href="../views/statproduit.php">
              <i class="bi bi-circle"></i><span>statistique produits</span>
            </a>
          </li>
          </ul>
        </li>
  ...
  <div class="form-row">
    <div class="form-group col-md-6">
      <label for="inputEmail4">Id pub</label>
      <input type="text" class="form-control" id="inputEmail4" value="<?PHP echo $id_pub ?>" name="id_pub" placeholder="id_pub">
    </div>
    <div class="form-group">
        <div class="form-group col-md-12">
        <label >Type</label>
      <select name="typepub" class="form-control" name="typepub" value="">
  ...
  <div class="form-group">
    ...
    <label for="inputAddress">Image</label>
      <td><img src="../img/<?php echo $row['imagepub'];?>" width="100" height="100"></td>
      <input type="file" name="imagepub">
  </div>
  <div class="form-group col-md-6">
    <label for="inputAddress">nom pub</label>
    <input type="text" class="form-control" id="inputAddress" value="<?PHP echo $nompub ;?>" name="nompub" placeholder="nompub">
  </div>
  </div>
  <div class="form-row">
    <div class="form-group col-md-4">
      <label >prix sans remise</label>
         <input type="float" class="form-control" id="inputAddress" value="<?PHP echo $prix_sans_remise ;?>" name="prix_sans_remise" placeholder="prix_sans_remise">
    </div>
  </div>
  <div class="form-row">
    <div class="form-group col-md-4">
      <label >prix avec remise</label>
         <input type="float" class="form-control" id="inputAddress" value="<?PHP echo $prix_avec_remise ;?>" name="prix_avec_remise" placeholder="prix_avec_remise">
    </div>
  </div>
  <div class="form-row">
    <div class="form-group col-md-4">
      <label for="inputCity">Description publicite</label>
      <input type="text" class="form-control"  value="<?PHP echo  $descriptionpub ;?>"  name="descriptionpub" id="descriptionpub">
    </div>
  </div>

  <div class="form-row">
    <div class="form-group col-md-4">
      <label >quantite publicite</label>
         <input type="float" class="form-control" id="inputAddress" value="<?PHP echo $quantitepub ;?>" name="quantitepub" placeholder="quantitepub">
    </div>
  </div>

  <div class="form-group">
  </div>
<!--<input type="hidden" name="id_pub" value="<?PHP echo $_GET['id'];?>">-->
...
if (isset($_POST['modifier'])){
  ...
  $publicite= new Publicite($_POST['id_pub'],$_POST['typepub'],$_POST['imagepub'],$_POST['nompub'],$_POST['prix_sans_remise'],$_POST['prix_avec_remise'],$_POST['descriptionpub'],$_POST['quantitepub'],$_POST['ida']);
  var_dump($publicite);
  $PubliciteC->modifierpublicite($publicite,$_POST['id_pub']);
  echo $_POST['id_pub'];
echo ("<script LANGUAGE='JavaScript'>window.location.href='../views/consulterpublicite.php';</script>");
