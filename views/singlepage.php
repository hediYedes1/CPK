...
if (isset($_GET["msg"]) && $_GET["msg"] === "oui") {
    echo '<div class="alert alert-success" role="alert">Successfully added to the cart!</div>';
}


if (isset($_GET["msg"]) && $_GET["msg"] === "msg") {
					...
					<div class="col-md-12">
						<div class="row">
							<div class="products-tabs">
                                ...
                                <input type="hidden" name="product-id" value="<?PHP echo $row['id_article']; ?>">
                                    <div class="col d-grid">
                                    <a href="../controller/addCommandeBuy.php?produit_id=<?PHP echo $row['id_article']; ?>&total_price=<?PHP echo $row['prix']; ?>" class="btn btn-success btn-lg" >Buy</a>
                                    </div>
                                    <div class="col d-grid">
