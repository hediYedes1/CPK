            ...
            <div class="align-self-center collapse navbar-collapse flex-fill  d-lg-flex justify-content-lg-between" id="templatemo_main_nav">
                ...
                <div class="navbar align-self-center d-flex">
                    ...
                    <div id="mySidebar" class="sidebar">
                        <a style="color: whitesmoke" href="javascript:void(0)" class="closebtn" onclick="closeNav()">&times;</a>
                        <a style="color: whitesmoke" href="#"><?php echo $userActual['nom'] ?></a>
                        <a style="color: whitesmoke" href="profile.php">Profile</a>
                        <a style="color: whitesmoke" href="forgot_password_key.php">Change Password</a>
                        <form action="" method="POST"> <button style="margin-left: 25px; background-color: indianred;color: white" type="submit"  name="delete-acc" >Delete Account</button></form>
                        <?php
                        if ($user1->getStateById($userId) == "Admin")
                        echo '<a style="color: darkseagreen" href="../Back/tables-general.php">Dashboard</a>';
                        ?>

                        <a style="color: darkseagreen" href='login.php'>Log out</a>
                    </div>
