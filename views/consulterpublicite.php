        ...
        <ul id="produits-nav" class="nav-content collapse " data-bs-parent="#sidebar-nav">
          <li>
            <a href="../views/publicite.php">
              <i class="bi bi-circle"></i><span>ajouter publicite</span>
            </a>
          </li>
          <li>
            <a href="../views/consulterpublicite.php">
              <i class="bi bi-circle"></i><span>consulter publicite</span>
            </a>
          </li>
          <li>
            <a href="../views/statproduit.php">
              <i class="bi bi-circle"></i><span>statistique publicite</span>
            </a>
          </li>
          </ul>
        </li>
