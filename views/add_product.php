...
if (isset($_POST['add'])) {
    ...
    if ($image_size > 2000000) {
        ...
        $add_product = $conn->prepare("INSERT INTO `produits`(id, name, prix, image) VALUES(?,?,?,?)");
...
<body>
    ...
    <section class="product-form">
        ...
        <form action="" method="POST" enctype="multipart/form-data">
            ...
            <input type="number" name="price" placeholder="enter product price" required min="0" max="9999999999"
