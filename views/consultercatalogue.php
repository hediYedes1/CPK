...
// {
// $CatalogueC = $CatalogueC->Recherche($_GET['search']);
// } else
// $tab = $CatalogueC->afficherCatalogue($Catalogue);
?>
...
Modifier</a></td>
<td><a href="../views/publicite.php?id=<?PHP echo $row['id_article']; ?>" style="text-decorations:none; color:white;"  class="btn btn-warning">
ajouter publicite</a></td>
</tr>
