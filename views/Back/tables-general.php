            ...
            <div class="card-body" style="width: 1110px">
              ...
              <!-- Default Table -->
                <form action="" method="POST">
                    <button type="submit" class="tri-button" name="trier" >
                        Trier
                    </button>
                </form>
          <div class="card" style="width: 1110px">
            <div class="card-body table-responsive" style="width: 1110px">
            ...
            <?php if (!empty($users)) { ?>
              <?php foreach ($users as $user) { ?>
                      ...
                      <td><button class="update-button" id="update_but"   data-user-id="<?php echo $user['id_user']; ?>">Update</button></td>
